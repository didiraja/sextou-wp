 ...
 * 
 * SEXTOUSOC->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Sextou_Social_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		SEXTOUSOC
 * @subpackage	Classes/Sextou_Social_Settings
 * @author		Didico
 * @since		1.0.0
 */
class Sextou_Social_Settings{
	...
	/**
	 * Our Sextou_Social_Settings constructor 
	...
	function __construct(){
		...
		$this->plugin_name = SEXTOUSOC_NAME;
	}
	...
	public function get_plugin_name(){
		return apply_filters( 'SEXTOUSOC/settings/get_plugin_name', $this->plugin_name );
	}
}
